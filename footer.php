  <footer>
    <div class="footer-widget-area bg-light ptb-100">
      <div class="container">
        <div class="row">
          <div class="col-12 col-sm-12 col-md-4 col-lg-5 mb-sm-40">
            <div class="footer-widget about">
              ...
              <div class="widget-content">
                <p>We have Experienced team backed by Powerful, fast & secure technology across all platforms -
				Mobile, Tablet, Desktop and Web</p>
              </div>
            </div>
          </div>
          <!-- Widget End -->
            ...
            <div class="footer-widget">
              ...
              <div class="widget-content mt-20">
                <ul class="list-unstyled">
                  <li><a href="brokerage-calculator.php">Calculator</a></li>
          ...
          <div class="col-6 col-sm-3 col-md-2 col-lg-2">
            <div class="footer-widget">
              <h4 class="widget-title mb-10">Knowledge</h4>
              <hr class="line">
              <div class="widget-content mt-20">
                <ul class="list-unstyled">
                  <li><a href="#">New to Market</a></li>
                  <li><a href="#">Analytics</a></li>
                  <li><a href="#">Super Investor</a></li>
                  <li><a href="#">Active Trader</a></li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <div class="footer-copyright bg-white ptb-15">
      <div class="container d-sm-flex">
        <p class="mb-0">Copyrights &copy; 2020 All Rights Reserved by Broking India</p>
        <p class="mb-0 ml-auto">Design by Tellusglint Private Limited</p>
      </div>
    </div>
  </footer>
  <!-- Footer Secion End -->
