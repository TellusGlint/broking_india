                        ...
                        <div class="col-12">
                            <form class="form-horizontal mt-3 form-material" action="authenticate.php" method="post" enctype="multipart/form-data">
                                <div class="form-group mb-3">
                                    <div class="col-xs-12">
                                        <input class="form-control" type="email" required="" name="email" placeholder="Email_ID">
                                    </div>
                                </div>
                                <div class="form-group mb-3 ">
                                    <div class="col-xs-12">
								...
								<div class="form-group mb-3 ">
                                    <div class="col-xs-12">
                                        <input class="form-control" type="text-area"  name="address" placeholder="Address">
                                    </div>
                                </div>
								<div class="form-group mb-3 ">
                                    <div class="col-xs-12">
                                        <input class="form-control" type="text" required="" name="phone" placeholder="Mobile">
                                    </div>
                                </div>
                                <div class="form-group mb-3 ">
                                    <div class="col-xs-12">
